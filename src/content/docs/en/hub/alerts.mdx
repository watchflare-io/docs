...
<Callout type="info">
  Webhook notifications (Discord, Slack, Telegram, generic HTTP) are configured in the same **Settings → Notifications** page. See [Webhook notifications](/hub/webhooks/).
</Callout>
