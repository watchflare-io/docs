---
title: "Configuration"
description: "All environment variables accepted by the Watchflare Hub, with defaults and usage notes."
---
...
- [HTTPS setup](/hub/https/) — serve the dashboard over HTTPS directly from the Hub
- [Reverse proxy](/hub/reverse-proxy/) — put Caddy or Nginx in front of the Hub
