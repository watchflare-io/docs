...
<PageSchema schema={{
  ...
  "step": [
    ...
    },
    {
      ...
      "text": "Generate the three required secrets (POSTGRES_PASSWORD, JWT_SECRET, SMTP_ENCRYPTION_KEY) using openssl rand -hex 32 and save them to a .env file in the same directory."
    },
    {
      "@type": "HowToStep",
      "position": 3,
