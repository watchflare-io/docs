...
The agent and Hub are independently versioned. Minor version differences (e.g. Hub v0.34 with agent v0.33) are generally compatible. When a newer Hub version introduces a new metric or RPC, older agents simply do not send that data and continue to work.
