...
description: "Deploy Watchflare Hub with Docker Compose and enroll your first agent. Five steps and zero optional config take you from install to live metrics in under 5 minutes."
---
...
<Callout type="info">
  ...
  gRPC communication with agents. No manual certificate setup is needed.
</Callout>
...
- [Configure alerts](/hub/alerts/) (CPU, memory, disk, load, and temperature thresholds, plus host-offline notifications)
