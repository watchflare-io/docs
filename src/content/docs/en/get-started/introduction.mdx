...
description: "Open-source, self-hosted server monitoring: agents report metrics to the Hub over gRPC/TLS. Learn what the dashboard shows and which platforms are supported."
---
