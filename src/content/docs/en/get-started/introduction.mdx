...
- **Alerts.** Threshold-based alerts on CPU, memory, disk, load, and temperature, plus host-offline notifications. Delivered by email and to any of the 26+ notification channels supported by [Shoutrrr](https://shoutrrr.nickfedor.com/) (Discord, Slack, Telegram, Matrix, Ntfy, Gotify, generic HTTP, and more).
