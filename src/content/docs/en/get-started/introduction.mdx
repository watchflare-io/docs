...
- **Alerts** — threshold-based alerts on CPU, memory, and disk, plus host offline notifications delivered by email and/or webhooks (Discord, Slack, Telegram, generic HTTP).
