...
**Notification channels** can forward alerts to Discord, Slack, Telegram, Matrix, Ntfy, Gotify, SMTP, generic HTTP, and more via [Shoutrrr](https://shoutrrr.nickfedor.com/). See [Notification channels](/hub/notifications/).
