...
description: "Réglez le SMTP dans Watchflare Settings pour envoyer les alertes par e-mail. Chiffrement, auth, stockage AES-256-GCM, message de test."
---
...
|------|-------------|-------------|
| `starttls` | `587` | Connexion en clair, puis STARTTLS. C'est le défaut à prendre. |
