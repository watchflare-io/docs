...
description: "Déployez le Hub Watchflare avec Docker Compose. Fichier Compose complet, génération des secrets, TimescaleDB, volumes de données et montages bind."
---
...
Par défaut, Docker range `pgdata` et `pki_data` où il veut. Pour les mettre à un chemin précis sur la machine (sauvegarde, inspection, migration), remplacez l'un, l'autre, ou les deux par un montage bind vers un dossier local.
