...
description: "Déployez le Hub avec Docker Compose et enrôlez votre premier agent. Cinq étapes, zéro configuration optionnelle : de l'installation aux métriques en moins de 5 minutes."
---
...
Ouvrez `http://your-host:8080` dans le navigateur. Sur une installation neuve, vous atterrissez directement sur la page de création de compte. Saisissez votre e-mail et un mot de passe solide.
...
Vous pouvez ensuite ouvrir les métriques temps réel et les graphiques d'historique. L'inventaire des paquets fait une première analyse 60 secondes après le démarrage de l'agent, puis tous les jours à 03:00.
...
- [Lire les variables d'environnement du Hub](/fr/hub/configuration/) (ports, modes TLS, sécurité des cookies)
