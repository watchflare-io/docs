/**
 * Icon library — inner SVG content (paths, circles, etc.)
 * Used by Icon.astro. All icons are 24×24, stroke-based (Lucide style).
 */
export const icons = {
  ...
  tip: '<path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>',
  ...
  arrowRight: '<path d="M5 12h14m0 0L13 6m6 6L13 18"/>',
