...
export const nav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/hub/notifications/', label: 'Notification channels', labelFr: 'Canaux de notification' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/agent/docker-metrics/', label: 'Docker container metrics', labelFr: 'Métriques des conteneurs Docker' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/monitoring/containers/', label: 'Container metrics', labelFr: 'Métriques des conteneurs' },
  ...
  },
  {
    ...
    items: [
      { href: '/reference/hub-env/', label: 'Hub environment variables', labelFr: "Variables d'environnement du Hub" },
