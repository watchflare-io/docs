...
Required frontmatter: `title` and `description`. New pages must also be added to `src/utils/nav.ts`. French MDX is optional; without it, `/fr/...` falls back to English. Get Started, Hub, Agent, and Monitoring are already translated.
