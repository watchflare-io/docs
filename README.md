...
Site chrome (navigation, search, home) is available in **English** and **French**. Get Started and Hub have French pages; other `/fr/...` URLs fall back to English until translated.
