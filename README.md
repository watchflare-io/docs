...
Site chrome (navigation, search, home) is available in **English** and **French**. Get Started, Hub, Agent, Monitoring, and Reference have French pages; the changelog `/fr/changelog/` falls back to English until translated.
