...
Site chrome (navigation, search, home) is available in **English** and **French**. Documentation pages are written in **English**; French URLs (`/fr/...`) fall back to the English content until translations exist.
